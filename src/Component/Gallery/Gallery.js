                    ...
                    {Photo.map((val, key) => {
                        return (
                            <Col className="col-md-4 col-10 col-xxl-4 mx-auto my-2" key={key}>
                                <Card>
                                    <Card>
                                        <img src="https://images.unsplash.com/photo-1621684793835-1dfa38971adb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" className='img-fluid' />
                                    </Card>
                                </Card>
                            </Col>
                        )
